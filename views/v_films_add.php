	...
	<div class="panel-body">
		<div class="container">
			...
			<form method='POST' action='/films/p_add' class="form-signin">
				...
				<input type="text" placeholder="Running time" name='running_time_1' class="form-control" required>
				...
				<input type="text" placeholder="Subject" name='subject_1' class="form-control" required>
